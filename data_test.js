...
var HOMOPHONES = {
  ...
  'for': ['four', '4', 'far'],
  'eight': ['ate', '8', 'it'],
  'mother': ['muther', 'mather'],
  'father': ['fother', 'farther'],
  'bread': ['bred', 'brad'],
  'see': ['sea', 'si'],
  'eye': ['i', 'ai'],
  'here': ['hear', 'her'],
  ...
  'fish': ['fich', 'fis'],
  'rabbit': ['rabit', 'rabat'],
  'turtle': ['tortle', 'turtel'],
  'monkey': ['monky', 'munky'],
  'elephant': ['elefant', 'alifant'],
  'lion': ['lyan', 'lian'],
  'tiger': ['taiger', 'tyger'],
  'hungry': ['hangry'],
  'its': ['it', 'it\u0027s', 'eat', 'itz'],
  'water': ['watter', 'order'],
  'they': ['the', 'stay', 'day', 'dying'],
  'sing': ['thin', 'thing', 'seen', 'saying', 'sinn', 'king'],
  'you': ['u', 'ue', 'yo', 'your', 'use', 'yu'],
  'sit': ['set', 'seat', 'suit', 'seed', 'sid', 'city', 'it'],
  'crawls': ['cross', 'cralls', 'craws', 'crows', 'close', 'balls', 'calls'],
  'it': ['eat', 'at', 'its', 'id'],
  'hundred': ['hunderd', 'hundered', 'hundret', 'handred'],
  'thousand': ['thousend', 'thousan', 'tausan', 'tausand'],
  'twenty': ['twentey', 'twany', 'tweny'],
  'thirty': ['thirtey', 'thurty', 'therty'],
  'forty': ['fourtey', 'forty', 'fourty'],
  'fifty': ['fiftey', 'fifty', 'fiffty'],
  'sixty': ['sixtey', 'sixty', 'sixy'],
  'seventy': ['seventey', 'seventy', 'seveny'],
  'eighty': ['eightey', 'eighty', 'eighy'],
  'ninety': ['ninetey', 'ninety', 'niney'],
...
function saveCurrentUser(u) { localStorage.setItem(STORAGE.USER, JSON.stringify(u)); }
...
var CHAPTER_DATA = {
  1: {
    ...
    imgPrompts: [
      (k, S) => `Which image matches: "${CHAPTER_DATA[S.chapterId].items[k].word}"`
    ]
  },
  2: {
    items: {
      ...
      ten: { word: 'Ten', color: '#FF6F00', emoji: '10️⃣' },
    },
    batches: [
      ['one', 'two', 'three', 'four'],
      ['five', 'six', 'seven'],
  ...
  7: {
    isReview: true,
    // Collect all items from chapters 1-6 for review
    get allReviewItems() {
      const items = {};
    ...
    imgPrompts: [
      (k, S) => `Which image shows: "${CHAPTER_DATA[S.chapterId].items[k].word}"`,
      (k, S) => `Find the picture for: "${CHAPTER_DATA[S.chapterId].items[k].word}"`
    ],
  ...
  14: {
    ...
    speakPrompts: ['Pronounce this word', 'Say it clearly'],
    get items() {
      // This is for internal item lookup if needed by generateQuestions
      const allItems = {};
      for (let ch = 8; ch <= 13; ch++) {
        Object.assign(allItems, CHAPTER_DATA[ch].items);
      }
      return allItems;
    }
  },
  15: {
    ...
    transitions: [
      ...
      { icon: '🚀', title: 'Mükemmel!', subtitle: 'Neredeyse bitirdin, son bir set kaldı!', next: 'Son Kelimeler' }
    ],
    wordPrompts: ['Which sentence matches?', 'Choose the action', 'What are they doing?'],
    speakPrompts: ['Read the sentence 🎤', 'Say it clearly 🎤'],
    imgPrompts: [
      (k, S) => `Which image matches: "${CHAPTER_DATA[S.chapterId].items[k].sentence}"`
    ]
  },
  16: {
    isRepeatMode: true,
  ...
  21: {
    ...
    transitions: [{ icon: '🎨', title: 'Colors in action!', subtitle: 'Keep going with new sentences.', next: 'Finish strong' }],
    wordPrompts: ['Listen first, then repeat', 'Repeat after me', 'Say it clearly'],
    speakPrompts: ['Repeat this sentence 🎤', 'Say it out loud 🎤']
  },
  22: {
  ...
  28: {
    ...
    get allReviewItems() {
      ...
      [22, 23, 24, 25, 26, 27].forEach(chId => {
        const chData = CHAPTER_DATA[chId];
        Object.entries(chData.items).forEach(([key, val]) => {
    ...
    speakPrompts: ['Read the sentence 🎤', 'Say it clearly 🎤'],
    imgPrompts: [
      (k, S) => `Which image matches: "${CHAPTER_DATA[S.chapterId].items[k].sentence || CHAPTER_DATA[S.chapterId].items[k].word}"`
    ]
  },
  29: {
    isRepeatMode: true,
    ...
    wordPrompts: ['Which greeting matches?', 'Diyaloğu eşleştir'],
    speakPrompts: ['Diyaloğu seslendir 🎤', 'Say it naturally 🎤']
  },
  30: {
    isRepeatMode: true,
    items: {
      eleven: { word: '11 - Eleven', sentence: 'Eleven', image: 'images/numbers/ch30_num_11_v2_1773724155000_1773724215553.png' },
      twelve: { word: '12 - Twelve', sentence: 'Twelve', image: 'images/numbers/ch30_num_12_v2_1773724155000_1773724231695.png' },
      thirteen: { word: '13 - Thirteen', sentence: 'Thirteen', image: 'images/numbers/ch30_num_13_v2_1773724155000_1773724246024.png' },
      fourteen: { word: '14 - Fourteen', sentence: 'Fourteen', image: 'images/numbers/ch30_num_14_v2_1773724155000_1773724260935.png' },
      fifteen: { word: '15 - Fifteen', sentence: 'Fifteen', image: 'images/numbers/ch30_num_15_v2_1773724155000_1773724275428.png' },
      sixteen: { word: '16 - Sixteen', sentence: 'Sixteen', image: 'images/numbers/ch30_num_16_v2_1773724155000_1773724291226.png' },
      seventeen: { word: '17 - Seventeen', sentence: 'Seventeen', image: 'images/numbers/ch30_num_17_v2_1773724155000_1773724308206.png' },
      eighteen: { word: '18 - Eighteen', sentence: 'Eighteen', image: 'images/numbers/ch30_num_18_v2_1773724155000_1773724324933.png' },
      nineteen: { word: '19 - Nineteen', sentence: 'Nineteen', image: 'images/numbers/ch30_num_19_v2_1773724155000_1773724380818.png' },
      twenty: { word: '20 - Twenty', sentence: 'Twenty', image: 'images/numbers/ch30_num_20_v2_1773724155000_1773724394109.png' }
    },
    batches: [
    ...
    wordPrompts: ['Which number is this?', 'Sayıyı seç'],
    speakPrompts: ['Sayıyı seslendir 🎤', 'Say it clearly 🎤']
  },
  31: {
    isRepeatMode: true,
    items: {
      twenty: { word: '20 - Twenty', sentence: 'Twenty', image: 'images/numbers/ch30_num_20_v2_1773724155000_1773724394109.png' },
      thirty: { word: '30 - Thirty', sentence: 'Thirty', image: 'images/numbers/ch31_num_30_v2_1773724155000_1773724406887.png' },
      forty: { word: '40 - Forty', sentence: 'Forty', image: 'images/numbers/ch31_num_40_v2_1773724155000_1773724420861.png' },
      fifty: { word: '50 - Fifty', sentence: 'Fifty', image: 'images/numbers/ch31_num_50_v2_1773724155000_1773724436705.png' },
      sixty: { word: '60 - Sixty', sentence: 'Sixty', image: 'images/numbers/ch31_num_60_v1_1773724155000_1773724450331.png' },
      seventy: { word: '70 - Seventy', sentence: 'Seventy', image: 'images/numbers/ch31_num_70_v1_1773724155000_1773724461559.png' },
      eighty: { word: '80 - Eighty', sentence: 'Eighty', image: 'images/numbers/ch31_num_80_v1_1773724155000_1773724475514.png' },
      ninety: { word: '90 - Ninety', sentence: 'Ninety', image: 'images/numbers/ch31_num_90_v1_1773724155000_1773724539891.png' },
      hundred: { word: '100 - One hundred', sentence: 'One hundred', image: 'images/numbers/ch31_num_100_final_v9_1773750840000_1317_1773742258174.png' },
      thousand: { word: '1000 - One thousand', sentence: 'One thousand', image: 'images/numbers/ch31_num_1000_final_v9_1773750840000_1317_1773742277417.png' }
    },
    batches: [
  ...
  32: {
    ...
    wordPrompts: ['Answer the question', 'Diyaloğu seç'],
    speakPrompts: ['Cevap ver 🎤', 'Say it naturally 🎤']
  },
  33: {
    isQAMode: true,
    items: {
    ...
    wordPrompts: ['Görsele bak ve soruyu oku', 'Soru-Cevap Eşleştir'],
    speakPrompts: ['Soruyu sor 🎤', 'Cevabı söyle 🎤']
  },
  34: {
    isQAMode: true,
    items: {
      ...
      whose_cat: { word: 'Whose cat is this?', sentence: 'This is her cat.', image: 'images/dialogue/ch34_her_cat.png' },
      are_they_happy: { word: 'Are they happy?', sentence: 'Yes, they are.', image: 'images/dialogue/ch34_they_happy.png' },
      is_it_big: { word: 'Is it big?', sentence: 'No, it is small.', image: 'images/dialogue/ch34_it_small.png' },
      are_you_hungry: { word: 'Are you hungry?', sentence: 'Yes, I am.', image: 'images/dialogue/ch34_i_hungry.png' },
      who_is_he: { word: 'Who is he?', sentence: 'He is my brother.', image: 'images/dialogue/ch34_he_brother.png' }
    },
    batches: [
    ...
    wordPrompts: ['Hangisi doğru cevap?', 'Eşleştirme yap'],
  ...
  35: {
    ...
    get allReviewItems() {
      return {
        ...CHAPTER_DATA[29].items,
        ...CHAPTER_DATA[30].items,
        ...CHAPTER_DATA[31].items,
        ...CHAPTER_DATA[32].items,
        ...CHAPTER_DATA[33].items,
        ...CHAPTER_DATA[34].items
      };
    },
    transitions: [
      { icon: '🏆', title: 'Phase 5 Tamamlandı!', subtitle: 'Harika bir tekrar yaptın.', next: 'Phase 6' }
    ],
    wordPrompts: ['Review time!', 'Doğru olanı seç'],
  ...
  36: {
    items: {
      ...
      adj_small: { word: 'Small', sentence: 'The mouse is small.', image: 'images/dialogue/ch36_small_mouse.png' },
      adj_good: { word: 'Good', sentence: 'This is good.', emoji: '👍' },
      adj_bad: { word: 'Bad', sentence: 'This is bad.', emoji: '👎' },
      adj_happy: { word: 'Happy', sentence: 'I am happy.', emoji: '😊' },
      adj_sad: { word: 'Sad', sentence: 'I am sad.', emoji: '😢' },
      adj_fast: { word: 'Fast', sentence: 'This car is fast.', emoji: '⚡' },
      adj_slow: { word: 'Slow', sentence: 'This turtle is slow.', emoji: '🐢' }
    },
    batches: [
  ...
  37: {
    items: {
      adj_hot: { word: 'Hot', sentence: 'The sun is hot.', emoji: '🔥' },
      adj_cold: { word: 'Cold', sentence: 'The ice is cold.', emoji: '❄️' },
      adj_old: { word: 'Old', sentence: 'He is old.', emoji: '👴' },
      adj_young: { word: 'Young', sentence: 'She is young.', emoji: '👧' },
      adj_beautiful: { word: 'Beautiful', sentence: 'The flower is beautiful.', emoji: '🌹' },
      adj_ugly: { word: 'Ugly', sentence: 'The monster is ugly.', emoji: '👹' },
      adj_cheap: { word: 'Cheap', sentence: 'It is cheap.', emoji: '🪙' },
      adj_expensive: { word: 'Expensive', sentence: 'It is expensive.', emoji: '💎' }
    },
    batches: [
    ...
    wordPrompts: ['Doğru sıfat hangisi?', 'Opposites'],
    speakPrompts: ['Söyle 🎤']
  },
  38: {
    items: {
      day_mon: { word: 'Monday', sentence: 'Today is Monday.', emoji: '📅' },
      day_tue: { word: 'Tuesday', sentence: 'Today is Tuesday.', emoji: '📅' },
      day_wed: { word: 'Wednesday', sentence: 'Today is Wednesday.', emoji: '📅' },
      day_thu: { word: 'Thursday', sentence: 'Today is Thursday.', emoji: '📅' },
      day_fri: { word: 'Friday', sentence: 'Today is Friday.', emoji: '📅' },
      day_sat: { word: 'Saturday', sentence: 'Today is Saturday.', emoji: '📅' },
      day_sun: { word: 'Sunday', sentence: 'Today is Sunday.', emoji: '📅' }
    },
    batches: [
    ...
    wordPrompts: ['Günü seç', 'What day is it?'],
    speakPrompts: ['Günü söyle 🎤']
  },
  39: {
    items: {
      mon_jan: { word: 'January', sentence: 'It is January.', emoji: '🗓️' },
      mon_feb: { word: 'February', sentence: 'It is February.', emoji: '🗓️' },
      mon_mar: { word: 'March', sentence: 'It is March.', emoji: '🗓️' },
      mon_apr: { word: 'April', sentence: 'It is April.', emoji: '🗓️' },
      mon_may: { word: 'May', sentence: 'It is May.', emoji: '🗓️' },
      mon_jun: { word: 'June', sentence: 'It is June.', emoji: '🗓️' },
      mon_jul: { word: 'July', sentence: 'It is July.', emoji: '🗓️' },
      mon_aug: { word: 'August', sentence: 'It is August.', emoji: '🗓️' },
      mon_sep: { word: 'September', sentence: 'It is September.', emoji: '🗓️' },
      mon_oct: { word: 'October', sentence: 'It is October.', emoji: '🗓️' },
      mon_nov: { word: 'November', sentence: 'It is November.', emoji: '🗓️' },
      mon_dec: { word: 'December', sentence: 'It is December.', emoji: '🗓️' }
    },
    batches: [
    ...
    wordPrompts: ['Ayı seç', 'Which month?'],
    speakPrompts: ['Ayı söyle 🎤']
  },
  40: {
    isQAMode: true,
    items: {
      qa_is_it_big: { word: 'Is it big?', sentence: 'Yes, it is very big.', emoji: '🐘' },
      qa_how_is_it: { word: 'How is the weather?', sentence: 'It is very hot.', emoji: '☀️' },
      qa_is_he_happy: { word: 'Is he happy?', sentence: 'No, he is sad.', emoji: '😢' },
      qa_is_it_cheap: { word: 'Is it cheap?', sentence: 'No, it is expensive.', emoji: '💎' },
      qa_is_she_young: { word: 'Is she young?', sentence: 'Yes, she is young.', emoji: '👧' }
    },
    batches: [
      ['qa_is_it_big', 'qa_how_is_it', 'qa_is_he_happy', 'qa_is_it_cheap', 'qa_is_she_young']
    ],
    wordPrompts: ['Soru-Cevap Eşleştir', 'Doğru cevabı bul'],
    speakPrompts: ['Cevapla 🎤']
  },
  41: {
    isQAMode: true,
    items: {
      qa_what_day: { word: 'What day is it today?', sentence: 'Today is Friday.', emoji: '📅' },
      qa_what_month: { word: 'What month is it?', sentence: 'It is October.', emoji: '🗓️' },
      qa_when_birthday: { word: 'When is your birthday?', sentence: 'My birthday is in June.', emoji: '🎂' },
      qa_is_it_mon: { word: 'Is it Monday?', sentence: 'No, it is Tuesday.', emoji: '📅' },
      qa_is_it_jan: { word: 'Is it January?', sentence: 'No, it is February.', emoji: '🗓️' }
    },
    batches: [
      ['qa_what_day', 'qa_what_month', 'qa_when_birthday', 'qa_is_it_mon', 'qa_is_it_jan']
    ],
    wordPrompts: ['Soru-Cevap Eşleştir', 'Bol eşleştirmeli bölüm'],
...
var CHAPTERS = [
  ...
  { id: 16, emoji: '🎤', name: 'Repeat After Me', words: 'Yavaş söyle, tekrar et', locked: false },
  ...
  { id: 21, emoji: '🎨', name: 'Colorful Things', words: 'Colors with objects', locked: false },
